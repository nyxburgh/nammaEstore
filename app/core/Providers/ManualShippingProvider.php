...
/**
 * "Manual" shipping — the vendor/admin types in the courier name and
 ...
 * default provider since most small/medium vendors on a marketplace
...
class ManualShippingProvider implements ShippingInterface
{
    ...
    public function getStatus(string $trackingNumber): string
    {
        ...
        // updated by whoever is shipping it, via the admin/vendor panel.
        return 'pending';
    }
}
