<?php $p=ADMIN_URL; ?>
<div class="d-flex align-items-center gap-3 mb-4"><a href="<?= $p ?>/sellers" class="btn btn-sm btn-outline-secondary btn-icon"><i class="bi bi-arrow-left"></i></a><div><h5 style="font-weight:800;margin:0;">Add New Seller</h5></div></div>
<div class="row g-3">
  <div class="col-lg-8">
  ...
  <div class="col-lg-4"><div class="card"><div class="card-header"><span class="card-title">Auto Assignment</span></div><div class="card-body">
    ...
    <p style="font-size:12px;color:var(--muted);margin-top:12px;margin-bottom:0;">Seller can upgrade from their dashboard.</p>
  </div></div></div>
</div>
