...
<div class="d-flex align-items-center justify-content-between mb-3">
  <div><h5 style="font-weight:800;margin:0;">Settlement Engine</h5><small class="text-muted">Vendor payout waterfall &amp; wallet crediting</small></div>
...
<div class="card mb-3">
  <div class="card-body">
    <p class="text-muted" style="font-size:13px;">
      The settlement engine evaluates every <strong>delivered &amp; paid</strong> order-vendor split against the
      eligibility gate — return window closed, no open return/replacement request, no open dispute, and (for
      subscription-plan vendors) an active subscription — then computes the deduction waterfall
...
<div class="row g-2">
  ...
  <div class="col-md-4">
    <div class="card"><div class="card-body">
      ...
      <p class="text-muted" style="font-size:12.5px;">Vendor payout requests awaiting approval.</p>
