...
<div class="row g-3">
  <?php foreach([['Sales Report','Daily revenue & order trends','graph-up-arrow','purple',$p.'/reports/sales'],['Commission Report','Per-vendor commission by period','percent','pink',$p.'/reports/commission'],['Vendor Report','Vendor performance & earnings','shop','green',$p.'/reports/vendors']] as [$t,$d,$i,$c,$u]): ?>
