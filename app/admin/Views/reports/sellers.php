<?php $p=ADMIN_URL; ?>
<div class="d-flex align-items-center gap-3 mb-4"><a href="<?= $p ?>/reports" class="btn btn-sm btn-outline-secondary btn-icon"><i class="bi bi-arrow-left"></i></a><div><h5 style="font-weight:800;margin:0;">Seller Performance</h5><small class="text-muted">All-time stats</small></div></div>
<div class="card"><div class="table-responsive"><table class="table mb-0">
  <thead><tr><th>#</th><th>Seller</th><th>Plan</th><th>Orders</th><th>Gross Sales</th><th>Commission</th><th>Net Earning</th></tr></thead>
  <tbody>
