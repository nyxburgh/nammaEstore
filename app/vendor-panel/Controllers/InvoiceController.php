...
class InvoiceController extends VendorController
{
    public function index(): void
    {
        ...
        $this->view('dashboard.main', array_merge($this->baseData(), [
            'title'         => 'Invoices',
            'section'       => 'invoices',
            'invoicesData'  => (new InvoiceRepository())->getForVendor(Auth::vendorId(), (int) $this->input('page', 1), $f),
            'filters'       => $f,
        ]));
    }
    ...
    public function download(string $id): void
    {
        ...
        if (!$invoice || (int) $invoice['vendor_id'] !== Auth::vendorId()) {
