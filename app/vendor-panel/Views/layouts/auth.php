...
<title><?= e($title??'Vendor') ?> — Namma E Store Seller Panel</title>
...
<link rel="stylesheet" href="<?= asset('vendor-panel/css/auth.css') ?>">
</head>
<body>
...
<main class="auth-main">
  <div class="auth-wrap">
    <div class="auth-brand">
      ...
      <div class="auth-tagline">Multi-Vendor Marketplace</div>
      <div class="vendor-chip">🏪 Seller Panel</div>
    </div>
    <div class="auth-card">
