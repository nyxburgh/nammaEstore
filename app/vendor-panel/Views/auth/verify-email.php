...
<form method="POST" action="<?= VENDOR_URL ?>/verify-email">
  <?= csrf_field() ?>
...
<form method="POST" action="<?= VENDOR_URL ?>/verify-email/resend" style="margin-top:14px;text-align:center;">
  <?= csrf_field() ?>
...
<div class="auth-alt"><a href="<?= VENDOR_URL ?>/logout" style="color:var(--gray);font-weight:400;">Sign out</a></div>
