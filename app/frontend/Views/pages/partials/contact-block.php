...
<div class="contact-grid">
  ...
  <form class="contact-form" method="POST" action="<?= APP_URL ?>/info/contact-us">
    <?= csrf_field() ?>
    <label for="cf-name">Your Name</label>
    <input id="cf-name" type="text" name="name" required maxlength="100" placeholder="Full name">
    <label for="cf-email">Email</label>
    <input id="cf-email" type="email" name="email" required maxlength="150" placeholder="you@example.com">
    <label for="cf-msg">Message</label>
    <textarea id="cf-msg" name="message" required maxlength="2000" placeholder="How can we help?"></textarea>
