...
<p class="auth-sub">Create your seller account and reach thousands of buyers</p>
<form method="POST" action="<?= SELLER_URL ?>/register">
  <?= csrf_field() ?>
  <div class="form-grid">
  ...
  <button type="submit" class="btn-auth">Create Seller Account →</button>
</form>
<div class="auth-alt">Already a seller? <a href="<?= SELLER_URL ?>/login">Sign in</a></div>
