...
<div class="filter-bar mb-4"><form method="get" class="row g-2 align-items-end" onsubmit="return validateForm(this)">
  <div class="col-md-3"><label class="form-label">From</label><input type="date" name="date_from" id="salesDateFrom" class="form-control" value="<?= e($from) ?>" oninput="validateField(this)" onblur="validateField(this)"></div>
  <div class="col-md-3"><label class="form-label">To</label><input type="date" name="date_to" class="form-control" data-gte-field="#salesDateFrom" value="<?= e($to) ?>" oninput="validateField(this)" onblur="validateField(this)"></div>
